...
<template>
	<div class="ContactsHrefs d-flex w-100">
		<div class="ContactsHrefs__phone mr-md-5">
			Позвоните по телефону:
			<a href="tel:+74951059169">+7 (495) 105 91 69</a>
		</div>
		<div class="ContactsHrefs__icons d-flex">
			<div class="ContactsHrefs__icon mt-3 mt-lg-0">
				<a href="https://m.me/carrotquest" aria-label="Facebook" class="mr-1">
			...
			<div class="ContactsHrefs__icon mx-4 mt-3 mt-lg-0">
				<a href="tg://resolve?domain=carrotquestbot" aria-label="Telegram" class="mr-1">
			...
			<div class="ContactsHrefs__icon mt-3 mt-lg-0">
				<a href="#open-chat" aria-label="Carrot quest chat" class="mr-1">
