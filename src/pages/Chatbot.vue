<template>
	<Layout :header="true" :footer="true"  class="page page-chatbot">
		...
		<b-container class="functions">
			...
			<b-row>
				<b-col cols="6" lg="3">
					<g-link href="/online-consultant/" class="functions__box box text-center p-4">
				...
				<b-col cols="6" lg="3">
					<g-link href="/lead-manager/" class="functions__box box text-center p-4">
				...
				<b-col cols="6" lg="3">
					<g-link href="/chatbot/" class="functions__box box text-center p-4">
				...
				<b-col cols="6" lg="3">
					<g-link href="/pop-up/" class="functions__box box text-center p-4">
