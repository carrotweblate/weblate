							...
							<b-row>
								<b-col cols="12" md="6" xl="12">
									<div class="calc__select__time font14px mt-4">
										<b-form-group label="Варианты оплаты:" v-model="ratioIndex" class="mb-0">
							...
							<b-row class="grey-text align-items-center">
								<b-col cols="4">
									...
									<b-tooltip target="all_features-12-1" placement="top">
										<div class="font12px text-left">
											Свойства: имя, телефон, email, местоположение, UTM-метки. События: зашел на сайт, написал в чат, сделал заказ и оплатил
										</div>
									</b-tooltip>
								</b-col>
								<b-col cols="4">
